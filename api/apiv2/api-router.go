...
func RegisterAPIv2(r *mux.Router) {
	...
	r.HandleFunc("/v2/resource/locvar/croblb/{num}", getcrobLb).Methods("GET").Queries("start", "{start}", "end", "{end}")
	r.HandleFunc("/v2/resource/locvar/irobli/{num}", getiRobLI).Methods("GET").Queries("start", "{start}", "end", "{end}")
	r.HandleFunc("/v2/resource/locvar/drobld/{num}", getdRobLD).Methods("GET").Queries("start", "{start}", "end", "{end}")
	r.HandleFunc("/v2/resource/locvar/droblp/{num}", getdRobLP).Methods("GET").Queries("start", "{start}", "end", "{end}")
	r.HandleFunc("/v2/resource/locvar/droblv/{num}", getdRobLV).Methods("GET").Queries("start", "{start}", "end", "{end}")
