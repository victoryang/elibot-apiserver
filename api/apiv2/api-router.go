...
func RegisterAPIv2(r *mux.Router) {
	...
	r.HandleFunc("/v2/resource/sysvar/croblb/{num}", getcrobLb).Methods("GET").Queries("start", "{start}", "end", "{end}")
	r.HandleFunc("/v2/resource/sysvar/irobli/{num}", getiRobLI).Methods("GET").Queries("start", "{start}", "end", "{end}")
	r.HandleFunc("/v2/resource/sysvar/drobld/{num}", getdRobLD).Methods("GET").Queries("start", "{start}", "end", "{end}")
	r.HandleFunc("/v2/resource/sysvar/droblp/{num}", getdRobLP).Methods("GET").Queries("start", "{start}", "end", "{end}")
	r.HandleFunc("/v2/resource/sysvar/droblv/{num}", getdRobLV).Methods("GET").Queries("start", "{start}", "end", "{end}")
