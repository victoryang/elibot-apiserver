...
STRU_INSTRUCT* LASER_exec_func(STRU_INSTRUCT *instruct, FILE *pfout);
STRU_INSTRUCT* LASERTRACK_exec_func(STRU_INSTRUCT *instruct, FILE *pfout);
STRU_INSTRUCT* MOVA_exec_func(STRU_INSTRUCT *instruct, FILE *pfout);
