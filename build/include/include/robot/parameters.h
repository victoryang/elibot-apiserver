...
#define PARA_ROBOT_MINIMUM_ACCTIME(s)        robot_para_data->data.Minimum_AccTime[s]
#define PARA_ROBOT_MAXIMUM_ACCTIME(s)        robot_para_data->data.Maximum_AccTime[s]
#define PARA_ROBOT_SMALL_LENGTH_TIMERANK(s)        robot_para_data->data.Time_rank[s]
#define PARA_ROBOT_MOTION_SMOOTH(s)        robot_para_data->data.Motion_Smooth[s]
#define PARA_ROBOT_DECELERATION_FACTOR        robot_para_data->data.Deceleration_Factor
...
void set_autorun_speed(int speed);
