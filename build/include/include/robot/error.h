...
#define COMMON_ERROR_NUM1_SUB22	22
#define COMMON_ERROR_NUM1_SUB23	23
#define COMMON_ERROR_NUM1_SUB24	24
#define COMMON_ERROR_NUM1_SUB25	25
...
#define COMPILE_ERROR_NUM9_SUB1 1
...
#define CALCULATE_ERROR_NUM0_SUB20	0x20
#define CALCULATE_ERROR_NUM0_SUB21	0x21
#define CALCULATE_ERROR_NUM0_SUB22	0x22
#define CALCULATE_ERROR_NUM0_SUB23	0x23
...
#define ARC_ERROR_NUM1		0x08001    //针对焊缝跟踪功能异常的报警
#define ARC_ERROR_NUM1_SUB0	0    //读取激光跟踪器数据错误
#define ARC_ERROR_NUM1_SUB1	1    //激光传感器连接失败
#define ARC_ERROR_NUM1_SUB2	2    //激光传感器开启失败
#define ARC_ERROR_NUM1_SUB3	3    //激光传感器关闭失败
#define ARC_ERROR_NUM1_SUB4	4    //激光传感器连接或开启失败
#define ARC_ERROR_NUM1_SUB5	5    //读取激光传感器数据错误
#define ARC_ERROR_NUM1_SUB6	6    //激光传感器标定错误
#define ARC_ERROR_NUM1_SUB7	7    //激光传感器标定成功
#define ARC_ERROR_NUM1_SUB8	8    //激光跟踪数据保存到文件错误
#define ARC_ERROR_NUM1_SUB9 9    //保存激光跟踪数据错误
#define ARC_ERROR_NUM1_SUB10 10    //激光跟踪开启失败
#define ARC_ERROR_NUM1_SUB11 11    //激光跟踪关闭失败
#define ARC_ERROR_NUM1_SUB12 12    //请首先打开并连接激光传感器
#define ARC_ERROR_NUM1_SUB13 13    //焊缝起始点搜寻失败
#define ARC_ERROR_NUM1_SUB14 14    //激光工艺号不匹配
...
#define POSINV_ERROR_NUM2     0x0B002//针对整圆指令
...
//外部轴报警
#define EXTERNAXIS_ERROR_NUM0        0x0D000 //外部轴参数设置过程中有误
#define EXTERNAXIS_ERROR_NUM0_SUB0  0  //外部轴回零过程中未设置机器人安全角度
#define EXTERNAXIS_ERROR_NUM0_SUB1  1  //外部轴标定错误
#define EXTERNAXIS_ERROR_NUM0_SUB2  2  //外部轴未标定
#define EXTERNAXIS_ERROR_NUM0_SUB3  3  //外部轴数据保存到文件错误
#define EXTERNAXIS_ERROR_NUM0_SUB4  4  //外部轴数据保存失败
#define EXTERNAXIS_ERROR_NUM0_SUB5  5  //获取外部轴数据失败
#define EXTERNAXIS_ERROR_NUM0_SUB6  6  //手动模式下，对应的外部轴未使能
#define EXTERNAXIS_ERROR_NUM0_SUB7  7  //外部轴标定成功
#define EXTERNAXIS_ERROR_NUM1        0x0D001//协同外部轴轴组号设置错误
#define EXTERNAXIS_ERROR_NUM1_SUB0  0  //外部轴轴组号超出范围
#define EXTERNAXIS_ERROR_NUM1_SUB1  1  //当前轴组不能使用
#define EXTERNAXIS_ERROR_NUM1_SUB2  2
#define EXTERNAXIS_ERROR_NUM1_SUB3  3
#define EXTERNAXIS_ERROR_NUM1_SUB4  4  //外部轴逆解错误
#define EXTERNAXIS_ERROR_NUM1_SUB5  5
#define EXTERNAXIS_ERROR_NUM1_SUB6  6
#define EXTERNAXIS_ERROR_NUM1_SUB7  7
#define EXTERNAXIS_ERROR_NUM1_SUB8  8
#define EXTERNAXIS_ERROR_NUM1_SUB9  9
#define EXTERNAXIS_ERROR_NUM1_SUB10  10
#define EXTERNAXIS_ERROR_NUM1_SUB11  11
...
#define OTHER_ERROR_NUM3_SUB7	7

#define OTHER_ERROR_NUM4		0x10004 //等待超时
#define OTHER_ERROR_NUM4_SUB0	0
#define OTHER_ERROR_NUM5	0x10005 //读取干涉区失败
#define OTHER_ERROR_NUM6	0x10006 //保存干涉区失败
#define OTHER_ERROR_NUM7	0x10007 //设置干涉区失败
#define OTHER_ERROR_NUM8	0x10008 //当前用户号超过最大序号
#define OTHER_ERROR_NUM9	0x10009 //当前工具未使用
#define OTHER_ERROR_NUMA	0x1000A //当前用户未使用
#define OTHER_ERROR_NUMB	0x1000B //当前轴未使用
#define OTHER_ERROR_NUMC	0x1000C //当前轴被禁止
#define OTHER_ERROR_NUMC_SUB0	0
#define OTHER_ERROR_NUMC_SUB1	1
#define OTHER_ERROR_NUMD	0x1000D //伺服报警
#define OTHER_ERROR_NUMD_SUB0	0
#define OTHER_ERROR_NUME	0x1000E //得到用户数据错误
#define OTHER_ERROR_NUMF	0x1000F //用户数据保存错误
#define OTHER_ERROR_NUMF_SUB0	0
#define OTHER_ERROR_NUMF_SUB1	1
#define OTHER_ERROR_NUM10	0x10010//创建用户坐标失败
#define OTHER_ERROR_NUM10_SUB0	0
#define OTHER_ERROR_NUM10_SUB1	1
#define OTHER_ERROR_NUM11		0x10011//进入干涉区
#define OTHER_ERROR_NUM11_SUB0	0
#define OTHER_ERROR_NUM11_SUB1	1
#define OTHER_ERROR_NUM12		0x10012//没有准备好不能放物料
#define OTHER_ERROR_NUM12_SUB0	0
#define OTHER_ERROR_NUM12_SUB1	1
#define OTHER_ERROR_NUM12_SUB2	2
#define OTHER_ERROR_NUM13		0x10013//没有准备好不能取物料
#define OTHER_ERROR_NUM14		0x10014//抓取失败
#define OTHER_ERROR_NUM14_SUB0	0
#define OTHER_ERROR_NUM14_SUB1	1
#define OTHER_ERROR_NUM15		0x10015//除零错误
...
/***********************************冲压工艺************************************************/
//冲压工艺报警
#define STAMP_ERROR_NUM0		0x11000	        // ＃站报警
#define STAMP_ERROR_NUM1		0x11001	        // 通用报警
#define STAMP_ERROR_NUM1_SUB2   2               // 加载冲压元数据失败

/***********************************数据库************************************************/
//数据库操作报警
#define DB_ERROR_NUM		    0x12000	        // 数据库报警
...
/***********************************跟踪工艺************************************************/
//跟踪工艺报警
#define TRACK_ERROR_NUM15		0x13000//跟踪功能错误
...
/***********************************视觉工艺************************************************/
//视觉工艺报警
#define VISION_ERROR_NUM15		0x14000//视觉功能错误
...
/***********************************视觉工艺************************************************/
//六维传感工艺报警
#define MULSENSOR_ERROR_MUM15   0X15000    //六维传感功能错误
#define ERROR_NOT_ALLOWED       1           //运行条件不满足

/***********************************视觉工艺************************************************/
//IO总线报警
#define IOBUS_ERROR_MUM0   0X16000		//IO总线报警
#define IOBUS_ERROR_MUM0_SUB0	0		//设备读写异常报警
