...
//new add（新添加）
void VectorSub(double v1[],double v2[],double v[],int num);
void VectorAdd(double v1[],double v2[],double v[],int num);
double Norm(double v[],int num);
double DotProduct(double v1[],double v2[],int num);
void Cross(double v1[],double v2[],double v[]);
void Scalar(double v[],double scale,int num);
void CombineAarray(double    array1[],double array2[],int m,int n,double array[]);
void CaliMatrixMultiplySlow(double *op1,double *op2,double *out,int m,int n,int l);
void MatrixToUnitQuaternion(double matrix[4][4],double pos[7]);
void UnitQuaternionToMatrix(double matrix[4][4],double pos[7]);
void QuaternionMultiply(double q1[],double q2[],double out[]);
